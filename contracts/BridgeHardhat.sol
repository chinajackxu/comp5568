...
contract BridgeHardhat is Ownable {
    IERC20 public token;
    ...
    // User locks tokens on Hardhat to transfer to Sepolia network
    ...
    // Bridge operator unlocks tokens on Hardhat when they are locked on Sepolia
